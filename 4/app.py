...
st.header('Fuel type, Cylinders, Type affect on Price')                  
list_for_scatter=['fuel','cylinders','type']
choice_for_scatter=st.selectbox('Price dependency on ',list_for_scatter)
fig2=px.scatter(df,x='price',y=choice_for_scatter,color='manufacturer',hover_data=['model_year'])
fig2.update_layout(
